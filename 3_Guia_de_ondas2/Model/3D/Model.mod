...
'# frequency = GHz
'# time = ns
'# frequency range: fmin = 11 fmax = 19
...
With Cylinder 
     ...
     .Component "component1" 
     .Material "PEC" 
     .OuterRadius "c_DExt/2" 
     .InnerRadius "c_DInt/2" 
     .Axis "y" 
     .Yrange "g_b/2", "c_Largo" 
     .Xcenter "0" 
     .Zcenter "11" 
     .Segments "0" 
     .Create 
...
With Cylinder 
     ...
     .Component "component1" 
     .Material "Vacuum" 
     .OuterRadius "c_DInt/2" 
     .InnerRadius "c_DPin/2" 
     .Axis "y" 
     .Yrange "g_b/2", "c_Largo+1" 
     .Xcenter "0" 
     .Zcenter "0" 
     .Segments "0" 
     .Create 
...
'@ delete shape: component1:GUIA_VACIO

'[VERSION]2017.1|26.0.1|20170224[/VERSION]
Solid.Delete "component1:GUIA_VACIO" 


'@ define brick: component1:GUIA_VACIO
...
With Brick
     ...
     .Xrange "-g_a/2", "g_a/2" 
     .Yrange "-g_b/2", "g_b/2" 
     .Zrange "-(lambda/4)", "g_l1+4" 
     .Create
End With


'@ boolean subtract shapes: component1:GUIA_COND, component1:GUIA_VACIO

'[VERSION]2017.1|26.0.1|20170224[/VERSION]
Solid.Subtract "component1:GUIA_COND", "component1:GUIA_VACIO" 
...
'@ delete shape: component1:COAX_EXTERNO

'[VERSION]2017.1|26.0.1|20170224[/VERSION]
Solid.Delete "component1:COAX_EXTERNO" 
...
'@ rename block: component1:solid1 to: component1:COAX_EXTERNO

'[VERSION]2017.1|26.0.1|20170224[/VERSION]
Solid.Rename "component1:solid1", "COAX_EXTERNO"
...
'[VERSION]2017.1|26.0.1|20170224[/VERSION]
Pick.PickFaceFromId "component1:COAX_EXTERNO", "3" 


'@ pick face

'[VERSION]2017.1|26.0.1|20170224[/VERSION]
Pick.PickFaceFromId "component1:COAX_INTERNO", "3" 
...
'@ define brick: component1:Planchuela
